"""
Migrated progressBar - Generated from existing widget
Original file: legacy-backup/examples/legacy-examples/global_dataset_demo.py
"""

from .base import ReactiveWidget, RenderContext, RenderResult

class progressBar(ReactiveWidget):
    """Migrated progress widget"""
