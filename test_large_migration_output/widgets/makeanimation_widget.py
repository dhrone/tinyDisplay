"""
Migrated MakeAnimation - Generated from existing widget
Original file: legacy-backup/examples/legacy-examples/tserv.py
"""

from .base import ReactiveWidget, RenderContext, RenderResult

class MakeAnimation(ReactiveWidget):
    """Migrated makeanimation widget"""
